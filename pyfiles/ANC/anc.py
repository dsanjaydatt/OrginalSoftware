...
def getNewPatientVisit(regno):
    try:
        sql = "select regno,pfname,pmname,psname,DATE_FORMAT(regdate,'%d/%m/%Y'),age,agetype,sex,education from patient_registration where regno='{}'".format(
            regno)
        cursor.execute(sql)
...
def getFilterAllANCData(regno):
    try:
        sql = "select * from anc_main where anc_status=1 AND regno='{}'".format(
            regno)
        cursor.execute(sql)
        return cursor.fetchall()
    except Exception as e:
...
def insertANCPatientHistory():
    ...
    try:
        if request.method == 'POST':
            ...
            if result == 1:
                try:
                    sql = "select count(*) from anc_patient_history where anc_id='{}'".format(
                        anc_id)
                    cursor.execute(sql)
...
def insertANCGravidaHistory():
    ...
    brstfed_btlefed = request.form.getlist(
        'brstfed_btlefed')  # Has Multiple Value
    ...
    try:
        if request.method == 'POST':
            ...
            if result == 1:
                try:
                    sql = "select count(*) from anc_gravida_history where anc_id='{}'".format(
                        anc_id)
                    cursor.execute(sql)
...
def insertANCFollowUpVisit():
    ...
    try:
        if request.method == 'POST':
            ...
            if result == 1:
                try:
                    sql = "select count(*) from anc_followup_visit where anc_id='{}'".format(
                        anc_id)
                    cursor.execute(sql)
...
def getANCPhView_Update(anc_id):
    try:
        sql = "select * from anc_patient_history where anc_id='{}'".format(
            anc_id)
        cursor.execute(sql)
        return cursor.fetchall()
    except Exception as e:
...
def getANCGhView_Update(anc_id):
    try:
        sql = "select * from anc_gravida_history where anc_id='{}'".format(
            anc_id)
        cursor.execute(sql)
        return cursor.fetchall()
    except Exception as e:
...
def getANCFoVView_Update(anc_id):
    try:
        sql = "select * from anc_followup_visit where anc_id='{}' order by FoV_date desc".format(
            anc_id)
        cursor.execute(sql)
        return cursor.fetchall()
    except Exception as e:
...
def getANCLcView_Update(anc_id):
    try:
        sql = "select * from anc_lab_checkup where anc_id='{}' order by lc_date desc".format(
            anc_id)
        cursor.execute(sql)
        return cursor.fetchall()
    except Exception as e:
...
def getANCUsrView_Update(anc_id):
    try:
        sql = "select * from anc_usg_report where anc_id='{}' order by usg_date desc".format(
            anc_id)
        cursor.execute(sql)
        return cursor.fetchall()
    except Exception as e:
...
def ANCGravidaDeleteRow(gh_id):
    try:
        if request.method == 'POST':
            sql = "delete from anc_gravida_history where gh_id='{}'".format(
                gh_id)
            cursor.execute(sql)
            db.commit()
...
def ANCSearchDate(frmdate, todate, ancgen):
    ...
    try:
        sql = "select r.regno,pfname,pmname,psname,age,agetype,sex,rtype,rfname,rmname,rsname,education,DATE_FORMAT(regdate,'%d/%m/%Y'),address,DATE_FORMAT(anc_date,'%d/%m/%Y'),a.follow_visit from patient_registration r,anc_main a where r.regno=a.regno and anc_status=1 and r.regdate between '{}' and '{}'".format(
            frmdate, todate)
        cursor.execute(sql)
        q = cursor.fetchall()
...
def ANCSearchImmu(ancimm):
    try:
        ...
        if(immustatus == 'All'):
            ...
            sql = "select r.regno,pfname,pmname,psname,age,agetype,sex,rtype,rfname,rmname,rsname,education,DATE_FORMAT(regdate,'%d/%m/%Y'),address,DATE_FORMAT(anc_date,'%d/%m/%Y'),FoV_bodytemp,FoV_utsize,FoV_oedema,FoV_variveins,FoV_immstatus from patient_registration r,anc_main a,anc_followup_visit fv where r.regno=a.regno and a.anc_id=fv.anc_id and anc_status=1 and r.regdate between '{}' and '{}' and fv.FoV_immstatus='{}'".format(
                frmdate, todate, immustatus)
...
def ANCSearchHb(anchb):
    try:
        ...
        if(frmdate != '' and todate != '' and hb != '' and blood == 'Exact'):
            sql = "select r.regno,pfname,pmname,psname,age,agetype,sex,rtype,rfname,rmname,rsname,education,DATE_FORMAT(regdate,'%d/%m/%Y'),address,DATE_FORMAT(anc_date,'%d/%m/%Y'),lc_hb,lc_bldgrp,lc_sickling,lc_tsh from patient_registration r,anc_main a,anc_lab_checkup lc where r.regno=a.regno and a.anc_id=lc.anc_id and a.anc_status=1 and regdate between '{}' and '{}'and CAST(lc.lc_hb AS DECIMAL(10,2))='{}'".format(
                frmdate, todate, hb)
            ...
            sql = "select r.regno,pfname,pmname,psname,age,agetype,sex,rtype,rfname,rmname,rsname,education,DATE_FORMAT(regdate,'%d/%m/%Y'),address,DATE_FORMAT(anc_date,'%d/%m/%Y'),lc_hb,lc_bldgrp,lc_sickling,lc_tsh from patient_registration r,anc_main a,anc_lab_checkup lc where r.regno=a.regno and a.anc_id=lc.anc_id and a.anc_status=1 and regdate between '{}' and '{}'".format(
                frmdate, todate, hb)
...
def ANCSearchBp(ancbp):
    try:
        ...
        if(frmdate != '' and todate != '' and sys != '' and dia != '' and pressure == 'Exact'):
            sql = "select r.regno,pfname,pmname,psname,age,agetype,sex,rtype,rfname,rmname,rsname,education,DATE_FORMAT(regdate,'%d/%m/%Y'),address,DATE_FORMAT(anc_date,'%d/%m/%Y'),FoV_systolic,FoV_diastolic,FoV_oedema,FoV_variveins,FoV_immstatus from patient_registration r,anc_main a,anc_followup_visit fv where r.regno=a.regno and a.anc_id=fv.anc_id and a.anc_status=1 and regdate between '{}' and '{}'and CAST(FoV_systolic AS INT)='{}' and CAST(FoV_diastolic AS INT)='{}'".format(
                frmdate, todate, sys, dia)
            ...
            sql = "select r.regno,pfname,pmname,psname,age,agetype,sex,rtype,rfname,rmname,rsname,education,DATE_FORMAT(regdate,'%d/%m/%Y'),address,DATE_FORMAT(anc_date,'%d/%m/%Y'),FoV_systolic,FoV_diastolic,FoV_oedema,FoV_variveins,FoV_immstatus from patient_registration r,anc_main a,anc_followup_visit fv where r.regno=a.regno and a.anc_id=fv.anc_id and a.anc_status=1 and regdate between '{}' and '{}'".format(
                frmdate, todate, sys, dia)
